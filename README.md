...
Consistent daily practice log — solving DSA problems every day, tracked publicly, organized by topic.
...
Each solved problem goes into its matching topic folder as:
```
<topic>/<problem-name-kebab-case>.java
```

Use the `TEMPLATE.md` file in this repo as a guide for how each problem's notes should look (approach, complexity, pattern learned).
